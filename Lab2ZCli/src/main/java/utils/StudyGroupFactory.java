...
public class StudyGroupFactory {
    ...
    private static java.time.LocalDate creationDate; //Поле не может быть null, Значение этого поля должно генерироваться автоматически
    ...
    private static java.time.LocalDate birthday; //Поле может быть null
